...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            PDPU: ["Sem-6"],
            books: ["Eric-Jorgenson_The-Almanack-of-Naval-Ravikant.pdf", "Elon Musk: How the Billionaire CEO of SpaceX.pdf"],
            skills: ["Back-end development", "TypeScript", "Ethers.js", "EVM (Ethereum Virtual Machine) ", "Hardhat", "SQL", "Truffle Framework", "Java", "PostgreSQL", "Spring Boot", "Spring Framework"],
            projects: ["nft-minter-thentic", "PixelKings", "NFT-MINTER", "bestbid-eth", "bestbid-corda", "search_twitter", "GameHistory"],
            interests: ["Software Engineering", "Deep Learning", "Computer Vision"],
            languages: ["Javascript", "Solidity", "Java", "TypeScript"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">0ilerr@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/oiler")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-oiler, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-oiler":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-oiler");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-oiler, todoist, trash, settings, sendmsg ]";
                }
                break;
